    ...
    <section>
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            ...
            <table className="min-w-full">
              ...
              <tbody className="bg-white">
                {filteredAndSortedTransactions.map((t, index) => (
                  <tr key={t.id} className={index % 2 === 0 ? undefined : 'bg-gray-50'}>
