    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
        ...
        <p className="text-gray-600 mb-6">
          Anda akan mencatat pembayaran untuk <span className="font-semibold text-gray-900">{customer.name}</span> sebesar <span className="font-semibold text-gray-900">{formatCurrency(customer.amount)}</span>. Lanjutkan?
        </p>
